...
def question_3_create_table():
    question_3_drop_table_script = '''
        drop table if exists  longen_zhao_td.project_question_3;'''
    ...
    question_3_create_table_script = '''
        CREATE TABLE Project_Question_3 (
            ...
            feel float,
            metar varchar,	
            PRIMARY KEY (valid,station)
        )
        '''

    session.execute(question_3_drop_table_script)
    session.execute(question_3_create_table_script)


if __name__ == "__main__":
    question_3_create_table()