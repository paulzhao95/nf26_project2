...
def get_insert_row_script(row: dict):
    insert_script = f'''
        insert into longen_zhao_td.project_question_3(
...
def question_3_insert_data_with_batch(fname):
...
if __name__ == '__main__':
    question_3_insert_data_with_batch('data/asos.txt')
    print('question 3 insert data done ')